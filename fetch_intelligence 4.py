...
def gnews_url(query: str, since_year: bool = True) -> str:
    # tbs=cdr:1,cd_min:1/1/2025 restricts results to this year only
    date_filter = "&tbs=cdr:1,cd_min:1%2F1%2F2025" if since_year else ""
    return f"https://news.google.com/rss/search?q={quote(query)}&hl=en-US&gl=US&ceid=US:en{date_filter}"
